...
vec4 cornersp( in vec3 vos, in vec3 nor, in vec3 dir )
{
	vec3 v1 = vos + dir.yzx + dir.zxy;
	vec3 v2 = vos - dir.yzx + dir.zxy;
	vec3 v3 = vos - dir.yzx - dir.zxy;
	vec3 v4 = vos + dir.yzx - dir.zxy;
